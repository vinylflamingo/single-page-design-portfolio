...
const LargeCTA = ({ fields }: LargeCTAProps): JSX.Element => {
  ...
  return (
    <section id="Large CTA">
      <div className="flex flex-row max-w-6xl p-16 justify-between items-center bg-design-black text-white rounded-xl m-4">
        <div className="basis-2/3 flex flex-col justify-between h-36">
          ...
          <Text
            tag="p"
            className="t-2 text-lg text-design-background w-11/12"
            field={fields.subheading}
          />
        </div>
        <div className="basis-1/3 pl-1 flex justify-end">
